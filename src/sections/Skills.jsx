...
const Skills = () => {
  return (
    <section id="skills" className="py-4 md:py-20">
      <Reveal>
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-8">
              <h3 className="mb-8 text-center text-2xl font-bold text-white lg:text-left">
            ...
            {/* Tools */}
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-8">
              <h3 className="mb-8 text-2xl font-bold text-white lg:text-left text-center">
                Tools
              </h3>
